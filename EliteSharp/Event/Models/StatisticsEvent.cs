...
namespace EliteSharp.Event.Models
{
    public partial class StatisticsEvent : EventBase
    {
        ...
        [JsonProperty("Bank_Account")] public BankAccountInfo BankAccount { get; private set; }

        [JsonProperty("CombatInfo")] public CombatInfo Combat { get; private set; }

        [JsonProperty("CrimeInfo")] public CrimeInfo Crime { get; private set; }

        [JsonProperty("SmugglingInfo")] public SmugglingInfo Smuggling { get; private set; }

        [JsonProperty("TradingInfo")] public TradingInfo Trading { get; private set; }

        [JsonProperty("MiningInfo")] public MiningInfo Mining { get; private set; }

        [JsonProperty("ExplorationInfo")] public ExplorationInfo Exploration { get; private set; }

        [JsonProperty("PassengersInfo")] public PassengersInfo Passengers { get; private set; }
        ...
        [JsonProperty("MulticrewInfo")] public MulticrewInfo Multicrew { get; private set; }
        ...
        public class BankAccountInfo
        {
            ...
            [JsonProperty("Current_Wealth")] public long CurrentWealth { get; private set; }

            [JsonProperty("Spent_On_Ships")] public long SpentOnShips { get; private set; }

            [JsonProperty("Spent_On_Outfitting")] public long SpentOnOutfitting { get; private set; }

            [JsonProperty("Spent_On_Repairs")] public long SpentOnRepairs { get; private set; }

            [JsonProperty("Spent_On_Fuel")] public long SpentOnFuel { get; private set; }

            [JsonProperty("Spent_On_Ammo_Consumables")]
            public long SpentOnAmmoConsumables { get; private set; }

            [JsonProperty("Insurance_Claims")] public long InsuranceClaims { get; private set; }

            [JsonProperty("Spent_On_Insurance")] public long SpentOnInsurance { get; private set; }

            [JsonProperty("Owned_Ship_Count")] public long OwnedShipCount { get; private set; }
        }
        ...
        public class CombatInfo
        {
            ...
            [JsonProperty("Bounties_Claimed")] public long BountiesClaimed { get; private set; }

            [JsonProperty("Bounty_Hunting_Profit")]
            public long BountyHuntingProfit { get; private set; }

            [JsonProperty("CombatInfo_Bonds")] public long CombatInfoBonds { get; private set; }

            [JsonProperty("CombatInfo_Bond_Profits")]
            public long CombatInfoBondProfits { get; private set; }

            [JsonProperty("Assassinations")] public long Assassinations { get; private set; }
        ...
        public class CraftingInfo
        {
            ...
            [JsonProperty("Recipes_Generated")] public long RecipesGenerated { get; private set; }
        ...
        public class CrewInfo
        {
            ...
            [JsonProperty("NpcCrewInfo_Hired")] public long NpcCrewInfoHired { get; private set; }

            [JsonProperty("NpcCrewInfo_Fired")] public long NpcCrewInfoFired { get; private set; }

            [JsonProperty("NpcCrewInfo_Died")] public long NpcCrewInfoDied { get; private set; }
        }
        ...
        public class CrimeInfo
        {
            ...
            [JsonProperty("Notoriety")] public long Notoriety { get; private set; }

            [JsonProperty("Fines")] public long Fines { get; private set; }

            [JsonProperty("Total_Fines")] public long TotalFines { get; private set; }

            [JsonProperty("Bounties_Received")] public long BountiesReceived { get; private set; }

            [JsonProperty("Total_Bounties")] public long TotalBounties { get; private set; }

            [JsonProperty("Highest_Bounty")] public long HighestBounty { get; private set; }
        }
        ...
        public class ExplorationInfo
        {
            ...
            [JsonProperty("Systems_Visited")] public long SystemsVisited { get; private set; }
            ...
            [JsonProperty("Efficient_Scans")] public long EfficientScans { get; private set; }

            [JsonProperty("Highest_Payout")] public long HighestPayout { get; private set; }
        ...
        public class MaterialTraderStatsInfo
        {
            ...
            [JsonProperty("Trades_Completed")] public long TradesCompleted { get; private set; }

            [JsonProperty("Materials_Traded")] public long MaterialsTraded { get; private set; }
        ...
        public class MiningInfo
        {
            ...
            [JsonProperty("MiningInfo_Profits")] public long MiningInfoProfits { get; private set; }

            [JsonProperty("Quantity_Mined")] public long QuantityMined { get; private set; }

            [JsonProperty("Materials_Collected")] public long MaterialsCollected { get; private set; }
        }
        ...
        public class SearchAndRescueInfo
        {
            ...
            [JsonProperty("SearchRescue_Traded")] public long SearchRescueTraded { get; private set; }

            [JsonProperty("SearchRescue_Profit")] public long SearchRescueProfit { get; private set; }

            [JsonProperty("SearchRescue_Count")] public long SearchRescueCount { get; private set; }
        }
        ...
        public class TradingInfo
        {
            ...
            [JsonProperty("Markets_Traded_With")] public long MarketsTradedWith { get; private set; }

            [JsonProperty("Market_Profits")] public long MarketProfits { get; private set; }

            [JsonProperty("Resources_Traded")] public long ResourcesTraded { get; private set; }
