...
namespace EliteSharp.Event.Models
{
    public partial class LoadoutEvent : EventBase
    {
        ...
        [JsonProperty("HullValue")] public long HullValue { get; private set; }

        [JsonProperty("ModuleInfosValue")] public long ModuleInfosValue { get; private set; }

        [JsonProperty("HullHealth")] public double HullHealth { get; private set; }

        [JsonProperty("UnladenMass")] public double UnladenMass { get; private set; }

        [JsonProperty("CargoCapacity")] public long CargoCapacity { get; private set; }

        [JsonProperty("MaxJumpRange")] public double MaxJumpRange { get; private set; }

        [JsonProperty("FuelCapacityInfo")] public FuelCapacityInfo FuelCapacity { get; private set; }

        [JsonProperty("Rebuy")] public long Rebuy { get; private set; }

        [JsonProperty("ModuleInfos")] public IReadOnlyList<ModuleInfo> ModuleInfos { get; private set; }
        ...
        public class FuelCapacityInfo
        {
            ...
            [JsonProperty("Main")] public double Main { get; private set; }

            [JsonProperty("Reserve")] public double Reserve { get; private set; }
        }
        ...
        public class ModuleInfo
        {
            ...
            [JsonProperty("Priority")] public long Priority { get; private set; }
