...
using EliteSharp.Exceptions;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace EliteSharp.Event.Provider
{
    /// <inheritdoc />
    public class EventProvider : IEventProvider
    {
        ...
        public Task<EventBase> ProcessJsonEvent(string json)
        {
            ...
            try
            {
                ...
                var eventName = parsedFromGame.Property("event")?.Value<string>() ?? throw new Exception("\"event\" property missing from journal entry");
